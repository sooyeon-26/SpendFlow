...
import { detectRepeatedSpending, generateWeeklyInsights, getCategoryTotals, getPreviousWeeklySpent, getRiskCategories, getWeeklySpent } from "../../utils/analytics";
...
export function ReportScreen() {
  ...
  const topRows = categories
    .map((category) => ({ category, amount: totals[category], percent: weekly ? (totals[category] / weekly) * 100 : 0 }))
